...
class ContentBasedRecommender:
    def __init__(self, max_similar_products=5000, min_score=0.0):
    ...
    def train(self, products):
        ...
        # Create TF-IDF matrix for processed data
    ...
    def get_similar_products(self, product_ids):
        ...
        for product_id in product_ids:
            ...
            # Append similarity data
            all_similarities.append(cosine_similarities)
        
        if not all_similarities:
            return []

        # Calculate the average similarity scores across all selected products
